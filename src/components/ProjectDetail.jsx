  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      ...
      const enhancedProject = {
        ...
        Github: selectedProject.Github || selectedProject.github || 'https://github.com/Gazell27',
      };
