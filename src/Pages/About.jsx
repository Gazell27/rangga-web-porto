    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Saya seorang mahasiswa Sistem Informasi dengan minat kuat pada dunia Frontend, Backend, dan Data Analytics. Saya senang mengeksplorasi cara kerja sebuah sistem, mulai dari bagaimana data diolah, bagaimana logika backend berjalan, hingga bagaimana tampilan frontend membentuk pengalaman pengguna. Bagi saya, teknologi adalah ruang untuk bereksperimen, belajar, dan menciptakan sesuatu yang memiliki nilai nyata.
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Life isn’t about who is the fastest, but about who is most willing to keep learning."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://ranggalthfi-portfolio-web.vercel.app/Cv%20Rangga%20Luthfi%20Firdaus..pdf" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
